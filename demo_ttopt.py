...
Run it from the root of the project as "python demo_ttopt.py".

As a result of the script work we expect the output in console like this:
"
...
Alpine-10d | evals=1.00e+05 | t_cur=1.66e-01 | e_x=3.29e+00 e_y=6.88e-06
----------------------------------------------------------------------
Alpine-10d | evals=1.00e+05 | t_all=2.50e+00 | e_x=3.29e+00 e_y=6.88e-06
"
